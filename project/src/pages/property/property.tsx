                ...
                <div className="property__host">
                  ...
                  <div className="property__host-user user">
                    <div className="property__avatar-wrapper property__avatar-wrapper--pro user__avatar-wrapper">
                      <img className="property__avatar user__avatar" src="img/avatar-angelina.jpg" width="74" height="74" alt="Host" />
                    </div>
              ...
              <div className="near-places__list places__list">
                <article className="near-places__card place-card">
                  ...
                  <div className="place-card__info">
                    ...
                    <h2 className="place-card__name">
                      <a href="#tbd">Wood and stone place</a>
                    </h2>
                ...
                <article className="near-places__card place-card">
                  ...
                  <div className="place-card__info">
                    ...
                    <h2 className="place-card__name">
                      <a href="#tbd">Canal View Prinsengracht</a>
                    </h2>
                ...
                <article className="near-places__card place-card">
                  ...
                  <div className="place-card__info">
                    ...
                    <h2 className="place-card__name">
                      <a href="#tbd">Nice, cozy, warm big bed apartment</a>
                    </h2>
                    <p className="place-card__type">Apartment</p>
                  </div>
                </article>
